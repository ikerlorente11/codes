/*
   ...
   Programa para visualizacion por monitor serie de las lecturas del MPU6050 para los ángulos Roll-Alabeo(X), Pitch-Cabeceo(Y) y Yaw-Guiñada(Z)
   Requiere librerias I2cdev y Simple_MPU6050 Mostrar en el Serial Plotter
